...
EXT_var F(pixel_to_vec)(COLOR*,var*,var,var pixel);
...
// A7 physics
#ifndef A8
EXT_var F(ph_selectgroup)(var);
EXT_var F(ph_setgravity)(VECTOR*);
EXT_var F(ph_setcorrections)(var,var);
EXT_var F(ph_setcollisions)(var,var);
EXT_var F(ph_setautodisable)(var,var,var,var);
EXT_var F(phent_settype)(ENTITY*,var,var);
EXT_var F(phent_addcentralforce)(ENTITY*,VECTOR* force);
EXT_var F(phent_addforceglobal)(ENTITY*,VECTOR* force,VECTOR* position);
EXT_var F(phent_addforcelocal)(ENTITY*,VECTOR* force,VECTOR* position);
EXT_var F(phent_addvelcentral)(ENTITY*,VECTOR* speed);
EXT_var F(phent_addvelglobal)(ENTITY*,VECTOR* speed,VECTOR* position);
EXT_var F(phent_addvellocal)(ENTITY*,VECTOR* speed,VECTOR* position);
EXT_var F(phent_addtorqueglobal)(ENTITY*,VECTOR*);
EXT_var F(phent_addtorquelocal)(ENTITY*,VECTOR*);
EXT_var F(phent_getangvelocity)(ENTITY*,VECTOR*);
EXT_var F(phent_getvelocity)(ENTITY*,VECTOR*,VECTOR*);
EXT_var F(phent_clearvelocity)(ENTITY*);
EXT_var F(phent_setmass)(ENTITY*,var,var);
EXT_var F(phent_setfriction)(ENTITY*,var);
EXT_var F(phent_setmaxspeed)(ENTITY*,var,var);
EXT_var F(phent_setdamping)(ENTITY*,var,var);
EXT_var F(phent_enable)(ENTITY*,var);
EXT_var F(phent_setgroup)(ENTITY*,var);
EXT_var F(phent_setelasticity)(ENTITY*,var,var);
EXT_var F(phent_getbounds)(ENTITY*,var,VECTOR*);
EXT_var F(phent_makelocal)(ENTITY*,VECTOR*,VECTOR*);
EXT_var F(phent_addobstruction)(ENTITY*,var,VECTOR*);
EXT_var F(phcon_add)(var,ENTITY*,ENTITY*);
EXT_var F(phcon_remove)(var);
EXT_var F(phcon_setparams1)(var,VECTOR*,VECTOR*,VECTOR*);
EXT_var F(phcon_setparams2)(var,VECTOR*,VECTOR*,VECTOR*);
EXT_var F(phcon_setmotor)(var,VECTOR*,VECTOR*,VECTOR*); 
EXT_var F(phcon_getposition)(var,VECTOR*);
EXT_var F(ph_setcontacts)(VECTOR*, VECTOR*, VECTOR*, VECTOR*);
#endif
...
EXT_var F(effect_cpy)(MATERIAL* to,MATERIAL* from);
EXT_var F(effect_load)(MATERIAL* mtl,char *filename);
...
EXT_var F(ent_clone)(ENTITY*);
EXT_var F(ent_cloneskin)(ENTITY*);
...
// passing an optional callback function activates lite-C debug mode.
// the callback function is called when a breakpoint is hit, and looks like this:
// int WINAPI OnBreakpoint(char *scriptname,long line);
// the script name (or NULL for the main script) and the line number is passed
// to the callback function.
// When using callback, make sure to create the exe with the linker option
